...
#define LIBGENS_LIGHT_ROOT_GENERATIONS_2024          101
#define LIBGENS_LIGHT_LIST_ROOT_GENERATIONS_2024     100
...
namespace LibGens {
	...
	public:
		...
		void save(string filename, int root_type = LIBGENS_LIGHT_ROOT_GENERATIONS);
	...
	public:
		...
		void save(string filename, int root_type = LIBGENS_LIGHT_LIST_ROOT_GENERATIONS);
