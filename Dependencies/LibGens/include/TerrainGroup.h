...
#define LIBGENS_TERRAIN_GROUP_ROOT_GENERATIONS_2024         101
...
namespace LibGens {
	...
	class TerrainGroup {
		...
		public:
			...
			void save(string filename_p, int root_type = LIBGENS_TERRAIN_GROUP_ROOT_GENERATIONS);
