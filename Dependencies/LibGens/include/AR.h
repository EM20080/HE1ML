...
namespace LibGens {
	class ArFile {
		...
		public:
			...
			void setPFIEntry(string name_p, unsigned int data_size_p, unsigned int absolute_data_address_p);
	...
	class ArPack {
		...
		public:
			...
			void savePFI2024(string filename);
			void readPFI(string filename);
