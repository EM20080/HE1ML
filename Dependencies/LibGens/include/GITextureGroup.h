...
#define LIBGENS_GI_TEXTURE_GROUP_ROOT_TYPE_GENERATIONS_2024    102
...
namespace LibGens {
	...
	class GITextureGroup {
		...
		public:
			...
			const vector<unsigned int> &getInstanceIndices();
	...
	class GITextureGroupInfo {
		...
		public:
			...
			void save(string filename, int root_type = LIBGENS_GI_TEXTURE_GROUP_ROOT_TYPE);
