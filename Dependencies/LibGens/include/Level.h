...
#define LIBGENS_LEVEL_XML_BGM            "BGM"
#define LIBGENS_LEVEL_XML_IS_STREAM      "IsStream"
...
#define LIBGENS_LEVEL_XML_CONST_G_FOG_DENSITY_W      "ms_ConstG_FogDensity.w"
...
namespace LibGens {
	...
	class SceneEffect {
		public:
			...
			float light_scattering_fog_density;
			...
			SceneEffect() {
				...
				light_scattering_fog_density = 0.0f;
